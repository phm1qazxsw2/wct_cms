...
<%
	...
	List<Map<String, Object>> rlist = rdmgr.retrieveListMap(
		"select LEFT(software_code,5) as ver, sum(count) as c, " + 
		"DATE_FORMAT(ctime, '%Y-%m-%d') as d from r3_device_login " +
		"where type=3 and software_code like '05%' group by ver, d order by d asc, ver asc;"
 	);
