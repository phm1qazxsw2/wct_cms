...
<%
	try {
		...
		int last_id = hp.getInt("last_id", 0);

		System.out.println("## in front/messages/more user=" + 
				u.getId() + " channel=" + channel_id);

		if (channel_id==0 || last_id==0) {			
		...
		List<Message> msgs = mmgr.retrieveList("channel_id=" + channel_id + " and id<" + last_id, 
