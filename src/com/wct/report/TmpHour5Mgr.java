...
public class TmpHour5Mgr extends dbo.Manager<TmpHour5>
{
    private static TmpHour5Mgr _instance = null;

    TmpHour5Mgr() {}

    public synchronized static TmpHour5Mgr getInstance()
    {
        if (_instance==null) {
            _instance = new TmpHour5Mgr();
        }
        return _instance;
    }

    public TmpHour5Mgr(int tran_id) throws Exception {
        super(tran_id);
    }
