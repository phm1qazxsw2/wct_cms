...
public class ProcessChallengerInfo5_149 {
    public ProcessChallengerInfo5_149() {
    }
    ...
    public static void main(String[] args) {
    	 ...
    	 * 
    	 */
    	File process_login_149 = null;
    	try {
    		
    		File path = new File(args[0]);
    		
	    	File dsource = new File(path, "WEB-INF/bi.datasource");
	    	process_login_149 = new File(path, "WEB-INF/process_login5_149");
	    	if (process_login_149.exists()) {
	    		throw new Exception("Another is running, cannot run more than 1 instance");
	    	}
	    	process_login_149.createNewFile();
	    	process_login_149.deleteOnExit();
