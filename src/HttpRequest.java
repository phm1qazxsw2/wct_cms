...
//            url_con.getOutputStream().close();
    ...
    public static void main(String[] args) {
    	String xmlInfo = "<?xml version='1.0' encoding='utf-8'?><request method='getLiveList'><parameters><version>01.00</version><mac>00-90-e6-00-08-52</mac><reqDataType>1</reqDataType><urlLevel>4</urlLevel></parameters></request>";
    	//String url = "http://imsarea.widecloud.com.cn/gy_ims/ims/interfaces/aliServlet";
    	String url = "http://imstv.playergetlist.com:8080/tvims/servlet/imsServiceServlet";
    	
    	String temp = HttpRequest.doPost(url,xmlInfo,"UTF-8");
